...
function placeXorO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        function checkWinConditions() {
            ...
            //O 0, 3, 6 condition
            else if (arrayIncludes('0O', '4O', '5O')) {drawWinLine(50, 304, 558, 304) }
            //O 1, 4, 7 condition
            ...
            //This condition checks for a tie. If none of the above conditions area met and
    ...
    function computersTurn() {
        ...
        let pickASquare;
        //This condition allows our while loop to keep trying ig a square is selected already.
        while (!success) {
            //A random number between 0-8 is selected
            pickASquare = String(Math.floor(Math.random() * 9));
            //If the random number evaluated returns true, thr square hasn't been selected yet.
    ...
    let x1 = coordX1,
        ...
        function animateLineDrawing() {
            ...
            if (x1 <= x2 && y1 <= y2) {
                ...
                if  (x < x2) { x += 10; }
                //This condition adds 1o to the previous end y endpoint
                if (y < y2) { y += 10; }
